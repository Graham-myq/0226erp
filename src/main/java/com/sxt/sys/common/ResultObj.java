...
public class ResultObj {
    ...
    public static final ResultObj RESET_ERROR = new ResultObj(Constast.OK, "重置成功");
    public static final ResultObj RESET_SUCCESS = new ResultObj(Constast.ERROR, "重置失败");

    public static final ResultObj DISPATCH_ERROR = new ResultObj(Constast.OK, "分配成功");
    public static final ResultObj DISPATCH_SUCCESS = new ResultObj(Constast.ERROR, "分配失败");
